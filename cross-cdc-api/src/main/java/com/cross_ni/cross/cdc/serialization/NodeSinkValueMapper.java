...
//        node.setName(sourceNode.getName().toString());
//        node.setNodeTypes(mapNodeTypes(sourceNode.getNodeTypes()));
//        node.setCustomAttributes(mapCustomAttributes(sourceNode.get()));

//        return node;
//    }
//
//    private static List<NodeType> mapNodeTypes(List<com.cross_ni.cross.cdc.model.source.NodeType> sourceNodeTypes) {
